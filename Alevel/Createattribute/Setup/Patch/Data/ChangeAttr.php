...
use Alevel\Createattribute\Model\Frontend\Vip as FrontModel;
use Alevel\Createattribute\Model\Backend\Vip as BackendModel;
    ...
    public function apply ()
    {
        ...
        $setup->addAttribute(
            ...
            [
                ...
                'label' => 'VIP Attribute', //A label of the attribute (that is, how it will be rendered in the backend and on the frontend).
                'input' => 'text',
                'source' => '',
